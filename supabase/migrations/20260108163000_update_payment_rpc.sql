-- Atomic Payment Processing RPC (Updated with Notifications)
-- Handles: Stock decrement, Order status update, Loyalty points awarding, AND Notifications
...
BEGIN
  ...
  -- 7. Create In-App Notification (NEW)
