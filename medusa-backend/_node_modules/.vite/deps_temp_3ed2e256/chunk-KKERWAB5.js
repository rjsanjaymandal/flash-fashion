...
var DialogHeadingContext = (0, import_react7.createContext)(void 0);
var DialogDescriptionContext = (0, import_react7.createContext)(void 0);
...
var ComboboxListRoleContext = (0, import_react8.createContext)(
  void 0
);
...
var ComboboxItemValueContext = (0, import_react8.createContext)(
  void 0
);
var ComboboxItemCheckedContext = (0, import_react8.createContext)(false);
...
var useCombobox = createHook(
  function useCombobox2({
    ...
    const prevSelectedValueRef = (0, import_react9.useRef)(void 0);
...
var children = (0, import_jsx_runtime3.jsx)(
  "svg",
  {
    "aria-hidden": "true",
    display: "block",
...
var useCompositeItem = createHook(
  function useCompositeItem2({
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime4.jsx)(CompositeItemContext.Provider, { value: providerValue, children: element }),
      [providerValue]
    );
    props = {
      id,
...
var useComboboxItem = createHook(
  function useComboboxItem2({
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime5.jsx)(ComboboxItemValueContext.Provider, { value, children: (0, import_jsx_runtime5.jsx)(ComboboxItemCheckedContext.Provider, { value: selected != null ? selected : false, children: element }) }),
      [value, selected]
    );
...
var CheckboxCheckedContext = (0, import_react17.createContext)(false);

// node_modules/@ariakit/react-core/esm/__chunks/HOITXJDS.js
var import_react18 = __toESM(require_react(), 1);
var import_jsx_runtime6 = __toESM(require_jsx_runtime(), 1);
var TagName15 = "span";
var checkmark = (0, import_jsx_runtime6.jsx)(
  "svg",
  {
    display: "block",
    fill: "none",
...
var useCheckboxCheck = createHook(
  function useCheckboxCheck2({ store, checked, ...props }) {
    const context = (0, import_react18.useContext)(CheckboxCheckedContext);
...
var useComboboxItemCheck = createHook(function useComboboxItemCheck2({ store, checked, ...props }) {
  const context = (0, import_react19.useContext)(ComboboxItemCheckedContext);
  checked = checked != null ? checked : context;
...
function splitValue(itemValue, userValue) {
  ...
  const parts = [];
  const span = (value, autocomplete = false) => (0, import_jsx_runtime7.jsx)(
    "span",
    {
...
var useComboboxItemValue = createHook(function useComboboxItemValue2({ store, value, userValue, ...props }) {
  ...
  const children3 = (0, import_react20.useMemo)(() => {
    if (!itemValue) return;
...
var PortalContext = (0, import_react21.createContext)(null);
...
var usePortal = createHook(function usePortal2({
  ...
  const context = (0, import_react22.useContext)(PortalContext);
  const [portalNode, setPortalNode] = (0, import_react22.useState)(null);
  const [anchorPortalNode, setAnchorPortalNode] = (0, import_react22.useState)(
    null
  );
  const outerBeforeRef = (0, import_react22.useRef)(null);
  const innerBeforeRef = (0, import_react22.useRef)(null);
  const innerAfterRef = (0, import_react22.useRef)(null);
  const outerAfterRef = (0, import_react22.useRef)(null);
  useSafeLayoutEffect(() => {
    const element = ref.current;
    if (!element || !portal) {
      setPortalNode(null);
  ...
  props = useWrapElement(
    ...
    (element) => {
      ...
      (0, import_jsx_runtime8.jsx)(PortalContext.Provider, { value: portalNode || context, children: element });
      ...
      element = (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
        preserveTabOrder && portalNode && (0, import_jsx_runtime8.jsx)(
          FocusTrap,
          {
            ref: innerBeforeRef,
      ...
      if (portalNode) {
        element = (0, import_react_dom.createPortal)(element, portalNode);
      }
      let preserveTabOrderElement = (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
        preserveTabOrder && portalNode && (0, import_jsx_runtime8.jsx)(
          FocusTrap,
          {
            ref: outerBeforeRef,
        ...
        (0, import_jsx_runtime8.jsx)("span", { "aria-owns": portalNode == null ? void 0 : portalNode.id, style: { position: "fixed" } }),
        preserveTabOrder && portalNode && (0, import_jsx_runtime8.jsx)(
          FocusTrap,
          {
            ref: outerAfterRef,
      ...
      if (anchorPortalNode && preserveTabOrder) {
        preserveTabOrderElement = (0, import_react_dom.createPortal)(
...
var HeadingContext = (0, import_react23.createContext)(0);

// node_modules/@ariakit/react-core/esm/__chunks/5M6RIVE2.js
var import_react24 = __toESM(require_react(), 1);
var import_jsx_runtime9 = __toESM(require_jsx_runtime(), 1);
function HeadingLevel({ level, children: children3 }) {
  const contextLevel = (0, import_react24.useContext)(HeadingContext);
  const nextLevel = Math.max(
    Math.min(level || contextLevel + 1, 6),
    1
  );
  return (0, import_jsx_runtime9.jsx)(HeadingContext.Provider, { value: nextLevel, children: children3 });
}
...
var useFocusableContainer = createHook(function useFocusableContainer2({ autoFocusOnShow = true, ...props }) {
  props = useWrapElement(
    props,
    (element) => (0, import_jsx_runtime10.jsx)(FocusableContext.Provider, { value: autoFocusOnShow, children: element }),
    [autoFocusOnShow]
  );
  return props;
});
...
function usePreviousMouseDownRef(enabled) {
  const previousMouseDownRef = (0, import_react25.useRef)(null);
...
function useNestedDialogs(store) {
  ...
  const wrapElement = (0, import_react27.useCallback)(
    (element) => (0, import_jsx_runtime11.jsx)(NestedDialogsContext.Provider, { value: providerValue, children: element }),
    [providerValue]
  );
...
function useRootDialog({
  ...
  const isRootDialog = (0, import_react28.useCallback)(() => {
...
var useDisclosureContent = createHook(function useDisclosureContent2({ store, alwaysVisible, ...props }) {
  ...
  props = useWrapElement(
    props,
    (element) => (0, import_jsx_runtime12.jsx)(DialogScopedContextProvider, { value: store, children: element }),
    [store]
  );
  const hidden = isHidden(mounted, props.hidden, alwaysVisible);
  const styleProp = props.style;
  const style = (0, import_react30.useMemo)(() => {
    if (hidden) {
...
var DisclosureContent = forwardRef2(function DisclosureContent2({
  ...
  return (0, import_jsx_runtime12.jsx)(DisclosureContentImpl, { ...props });
});
...
var Role = forwardRef2(
  ...
  function Role2(props) {
    return createElement(TagName23, props);
  }
);
Object.assign(
  Role,
...
function DialogBackdrop({
  ...
  if ((0, import_react31.isValidElement)(backdrop)) {
    return (0, import_jsx_runtime13.jsx)(Role, { ...props, render: backdrop });
  }
  const Component = typeof backdrop !== "boolean" ? backdrop : "div";
  return (0, import_jsx_runtime13.jsx)(Role, { ...props, render: (0, import_jsx_runtime13.jsx)(Component, {}) });
}
...
var useDialog = createHook(function useDialog2({
  ...
  const focusOnHide = (0, import_react32.useCallback)(
    (dialog, retry = true) => {
      const { disclosureElement } = store.getState();
  ...
  props = useWrapElement(
    props,
    (element) => (0, import_jsx_runtime14.jsx)(HeadingLevel, { level: modal ? 1 : void 0, children: element }),
    [modal]
  );
  ...
  props = useWrapElement(
    props,
    (element) => (0, import_jsx_runtime14.jsx)(DialogScopedContextProvider, { value: store, children: (0, import_jsx_runtime14.jsx)(DialogHeadingContext.Provider, { value: setHeadingId, children: (0, import_jsx_runtime14.jsx)(DialogDescriptionContext.Provider, { value: setDescriptionId, children: element }) }) }),
    [store]
  );
  props = {
    id,
...
function createDialogComponent(Component, useProviderContext = useDialogProviderContext) {
  return forwardRef2(function DialogComponent(props) {
    ...
    return (0, import_jsx_runtime14.jsx)(Component, { ...props });
  });
}
...
var usePopover = createHook(
  function usePopover2({
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime15.jsx)(
        "div",
        {
          ...wrapperProps,
          style: {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime15.jsx)(PopoverScopedContextProvider, { value: store, children: element }),
      [store]
    );
    props = {
...
var useComboboxList = createHook(
  function useComboboxList2({ store, alwaysVisible, ...props }) {
    ...
    const [hasListboxInside, setHasListboxInside] = (0, import_react34.useState)(false);
    const contentElement = store.useState("contentElement");
    useSafeLayoutEffect(() => {
      if (!mounted) return;
      const element = ref.current;
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime16.jsx)(ComboboxScopedContextProvider, { value: store, children: (0, import_jsx_runtime16.jsx)(ComboboxListRoleContext.Provider, { value: role, children: element }) }),
      [store, role]
    );
...
var useComboboxPopover = createHook(
  function useComboboxPopover2({
    ...
    const hiddenByClickOutsideRef = (0, import_react35.useRef)(false);
...
var TagValueContext = (0, import_react36.createContext)(null);
var TagRemoveIdContext = (0, import_react36.createContext)(
  null
);
...
function ComboboxProvider(props = {}) {
  ...
  return (0, import_jsx_runtime17.jsx)(ComboboxContextProvider, { value: store, children: props.children });
}
...
var useTab = createHook(function useTab2({
  ...
  const getItem = (0, import_react42.useCallback)(
    (item) => {
  ...
  if (store.composite) {
    ...
    props = {
      ...props,
      render: (0, import_jsx_runtime21.jsx)(
        CompositeItem,
        {
          ...defaultProps,
          render: store.combobox && store.composite !== store.combobox ? (0, import_jsx_runtime21.jsx)(CompositeItem, { ...defaultProps, store: store.combobox }) : defaultProps.render
        }
      )
    };
  }
...
var useTabList = createHook(
  function useTabList2({ store, ...props }) {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime22.jsx)(TabScopedContextProvider, { value: store, children: element }),
      [store]
    );
    if (store.composite) {
      props = {
...
var useTabPanel = createHook(
  function useTabPanel2({
    ...
    const scrollPositionRef = (0, import_react43.useRef)(
      /* @__PURE__ */ new Map()
    );
    ...
    const [hasTabbableChildren, setHasTabbableChildren] = (0, import_react43.useState)(false);
    (0, import_react43.useEffect)(() => {
      const element = ref.current;
      if (!element) return;
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime23.jsx)(TabScopedContextProvider, { value: store, children: element }),
      [store]
    );
    props = {
      id,
...
var SelectItemCheckedContext = (0, import_react44.createContext)(false);
var SelectHeadingContext = (0, import_react44.createContext)(null);
...
var useToolbar = createHook(
  function useToolbar2({
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime25.jsx)(ToolbarScopedContextProvider, { value: store, children: element }),
      [store]
    );
    props = {
      role: "toolbar",
...
// node_modules/@ariakit/react-core/esm/__chunks/N4AHYM2D.js
...
var useCompositeContainer = createHook(function useCompositeContainer2({ store, ...props }) {
  ...
  const isOpenRef = (0, import_react46.useRef)(false);
...
function useAutoFocusOnHide({
  ...
  const [autoFocusOnHide, setAutoFocusOnHide] = (0, import_react47.useState)(false);
  const mounted = store.useState("mounted");
  ...
  const finalFocusRef = (0, import_react47.useRef)(null);
  (0, import_react47.useEffect)(() => {
...
var NestedHovercardContext = (0, import_react47.createContext)(null);
var useHovercard = createHook(
  function useHovercard2({
    ...
    const [nestedHovercards, setNestedHovercards] = (0, import_react47.useState)([]);
    const hideTimeoutRef = (0, import_react47.useRef)(0);
    const enterPointRef = (0, import_react47.useRef)(null);
    const { portalRef, domReady } = usePortalRef(portal, props.portalRef);
    const isMouseMoving = useIsMouseMoving();
    ...
    const registerOnParent = (0, import_react47.useContext)(NestedHovercardContext);
    useSafeLayoutEffect(() => {
      if (modal) return;
      if (!portal) return;
      if (!mounted) return;
    ...
    const registerNestedHovercard = (0, import_react47.useCallback)(
      (element) => {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime27.jsx)(HovercardScopedContextProvider, { value: store, children: (0, import_jsx_runtime27.jsx)(NestedHovercardContext.Provider, { value: registerNestedHovercard, children: element }) }),
...
var useTooltip = createHook(
  function useTooltip2({
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime28.jsx)(TooltipScopedContextProvider, { value: store, children: element }),
      [store]
    );
...
var useHovercardAnchor = createHook(
  function useHovercardAnchor2({ store, showOnHover = true, ...props }) {
    ...
    const disabled = disabledFromProps(props);
    const showTimeoutRef = (0, import_react48.useRef)(0);
    (0, import_react48.useEffect)(() => () => window.clearTimeout(showTimeoutRef.current), []);
...
var useTooltipAnchor = createHook(
  function useTooltipAnchor2({ store, showOnHover = true, ...props }) {
    ...
    const canShowOnHoverRef = (0, import_react49.useRef)(false);
...
// node_modules/@ariakit/react-core/esm/__chunks/QKVSMXME.js
...
function useComputedStyle(store) {
  const [style, setStyle] = (0, import_react50.useState)();
  const contentElement = useStoreState(store, "contentElement");
  useSafeLayoutEffect(() => {
    if (!contentElement) return;
    const win = getWindow(contentElement);
...
var usePopoverArrow = createHook(
  function usePopoverArrow2({
    ...
    const [borderWidth, isRing] = (0, import_react50.useMemo)(() => {
    ...
    const children3 = (0, import_react50.useMemo)(
      () => (0, import_jsx_runtime29.jsx)("svg", { display: "block", viewBox: "0 0 30 30", children: (0, import_jsx_runtime29.jsxs)("g", { transform, children: [
        ...
        (0, import_jsx_runtime29.jsx)("path", { fill: "none", d: POPOVER_ARROW_PATH, mask: `url(#${maskId})` }),
        (0, import_jsx_runtime29.jsx)("path", { stroke: "none", d: POPOVER_ARROW_PATH }),
        (0, import_jsx_runtime29.jsx)("mask", { id: maskId, maskUnits: "userSpaceOnUse", children: (0, import_jsx_runtime29.jsx)(
          "rect",
          {
            x: "-15",
            y: "0",
...
var MenuItemCheckedContext = (0, import_react51.createContext)(
  void 0
);
...
// node_modules/@ariakit/react-core/esm/__chunks/6H6PBGDB.js
...
// node_modules/@ariakit/react-core/esm/__chunks/OUKAB3Z2.js
...
var useMenubar = createHook(
  function useMenubar2({
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime31.jsx)(MenubarScopedContextProvider, { value: store, children: element }),
      [store]
    );
    if (composite) {
      props = {
...
// node_modules/@ariakit/react-core/esm/__chunks/XAV7ZXSW.js
var import_jsx_runtime32 = __toESM(require_jsx_runtime(), 1);

// node_modules/@ariakit/react-core/esm/__chunks/WHZCNP67.js
...
// node_modules/@ariakit/react-core/esm/__chunks/2TJZ2QHB.js
var TagName57 = "p";
...
var usePopoverDisclosure = createHook(function usePopoverDisclosure2({ store, ...props }) {
  ...
  props = useWrapElement(
    props,
    (element) => (0, import_jsx_runtime33.jsx)(PopoverScopedContextProvider, { value: store, children: element }),
    [store]
  );
  props = {
    ...props,
...
// node_modules/@ariakit/react-core/esm/__chunks/OCCHVUS4.js
...
var useDialogDismiss = createHook(
  function useDialogDismiss2({ store, ...props }) {
    ...
    const children3 = (0, import_react54.useMemo)(
      () => (0, import_jsx_runtime35.jsxs)(
        "svg",
        {
          ...
          width: "1em",
          children: [
            (0, import_jsx_runtime35.jsx)("line", { x1: "4", y1: "4", x2: "12", y2: "12" }),
            (0, import_jsx_runtime35.jsx)("line", { x1: "4", y1: "12", x2: "12", y2: "4" })
          ]
        }
      ),
      []
...
// node_modules/@ariakit/react-core/esm/__chunks/QSVZ4NTN.js
...
// node_modules/@ariakit/react-core/esm/__chunks/FLYCYZJT.js
...
var useHeading = createHook(
  function useHeading2(props) {
    ...
    const level = (0, import_react55.useContext)(HeadingContext) || 1;
    const Element = `h${level}`;
    const tagName = useTagName(ref, Element);
    const isNativeHeading = (0, import_react55.useMemo)(
...
// node_modules/@ariakit/react-core/esm/__chunks/O4VW3LHI.js
var import_react56 = __toESM(require_react(), 1);
var TagName63 = "h1";
var useDialogHeading = createHook(
  function useDialogHeading2({ store, ...props }) {
    const setHeadingId = (0, import_react56.useContext)(DialogHeadingContext);
    const id = useId(props.id);
    useSafeLayoutEffect(() => {
...
// node_modules/@ariakit/react-core/esm/__chunks/4WJCKDQE.js
var TagName64 = "h1";
...
var useRadio = createHook(function useRadio2({
  ...
  const onChangeProp = props.onChange;
  const tagName = useTagName(ref, TagName65);
...
var useRadioGroup = createHook(
  function useRadioGroup2({ store, ...props }) {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime38.jsx)(RadioScopedContextProvider, { value: store, children: element }),
      [store]
    );
    props = {
      role: "radiogroup",
...
var useCompositeTypeahead = createHook(function useCompositeTypeahead2({ store, typeahead = true, ...props }) {
  ...
  const onKeyDownCaptureProp = props.onKeyDownCapture;
  const cleanupTimeoutRef = (0, import_react58.useRef)(0);
  const onKeyDownCapture = useEvent((event) => {
    onKeyDownCaptureProp == null ? void 0 : onKeyDownCaptureProp(event);
    if (event.defaultPrevented) return;
    if (!typeahead) return;
...
var useSelect = createHook(function useSelect2({
  ...
  props = useWrapElement(
    props,
    (element) => (0, import_jsx_runtime40.jsx)(SelectScopedContextProvider, { value: store, children: element }),
    [store]
  );
  const [autofill, setAutofill] = (0, import_react59.useState)(false);
  const nativeSelectChangedRef = (0, import_react59.useRef)(false);
          ...
          "select",
          {
            ...
            children: [
              toArray(value).map((value2) => {
                ...
                return (0, import_jsx_runtime40.jsx)("option", { value: value2, children: value2 }, value2);
              }),
              values.map((value2) => (0, import_jsx_runtime40.jsx)("option", { value: value2, children: value2 }, value2))
            ]
          }
        ),
        element
  ...
  const children3 = (0, import_jsx_runtime40.jsxs)(import_jsx_runtime40.Fragment, { children: [
    value,
    (0, import_jsx_runtime40.jsx)(SelectArrow, {})
  ] });
  const contentElement = store.useState("contentElement");
  props = {
    role: "combobox",
...
var useSelectHeading = createHook(
  function useSelectHeading2(props) {
    const [, setHeadingId] = (0, import_react60.useContext)(SelectHeadingContext) || [];
    const id = useId(props.id);
    useSafeLayoutEffect(() => {
      setHeadingId == null ? void 0 : setHeadingId(id);
      return () => setHeadingId == null ? void 0 : setHeadingId(void 0);
...
var useSelectItem = createHook(
  function useSelectItem2({
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime41.jsx)(SelectItemCheckedContext.Provider, { value: selected != null ? selected : false, children: element }),
      [selected]
    );
    props = {
      id,
...
var useSelectItemCheck = createHook(
  function useSelectItemCheck2({ store, checked, ...props }) {
    const context = (0, import_react62.useContext)(SelectItemCheckedContext);
    checked = checked != null ? checked : context;
    props = useCheckboxCheck({ ...props, checked });
    return props;
  }
...
var TagName77 = "div";
var SelectListContext = (0, import_react63.createContext)(null);
var useSelectList = createHook(
  function useSelectList2({
    ...
    const value = store.useState("value");
    const multiSelectable = Array.isArray(value);
    const [defaultValue2, setDefaultValue] = (0, import_react63.useState)(value);
    const mounted = store.useState("mounted");
    ...
    const headingContext = (0, import_react63.useContext)(SelectHeadingContext);
    const headingState = (0, import_react63.useState)();
    const [headingId, setHeadingId] = headingContext || headingState;
    const headingContextValue = (0, import_react63.useMemo)(
      () => [headingId, setHeadingId],
      [headingId]
    );
    const [childStore, setChildStore] = (0, import_react63.useState)(null);
    const setStore = (0, import_react63.useContext)(SelectListContext);
    (0, import_react63.useEffect)(() => {
      if (!setStore) return;
      setStore(store);
    ...
    props = useWrapElement(
      props,
      (element2) => (0, import_jsx_runtime42.jsx)(SelectScopedContextProvider, { value: store, children: (0, import_jsx_runtime42.jsx)(SelectListContext.Provider, { value: setChildStore, children: (0, import_jsx_runtime42.jsx)(SelectHeadingContext.Provider, { value: headingContextValue, children: element2 }) }) }),
...
// node_modules/@ariakit/react-core/esm/__chunks/BQYVKXYL.js
...
var useForm = createHook(function useForm2({
  ...
  const [shouldFocusOnSubmit, setShouldFocusOnSubmit] = (0, import_react65.useState)(false);
  (0, import_react65.useEffect)(() => {
  ...
  props = useWrapElement(
    props,
    (element) => (0, import_jsx_runtime45.jsx)(FormScopedContextProvider, { value: store, children: element }),
    [store]
  );
  const tagName = useTagName(ref, TagName82);
  props = {
...
// node_modules/@ariakit/react-core/esm/__chunks/YST7RWT5.js
...
var useFormControl = createHook(
  function useFormControl2({
    ...
    const getItem = (0, import_react66.useCallback)(
      (item) => {
...
var useCheckbox = createHook(
  function useCheckbox2({
    ...
    store = store || context;
    const [_checked, setChecked] = (0, import_react67.useState)(defaultChecked != null ? defaultChecked : false);
    ...
    const tagName = useTagName(ref, TagName84);
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime46.jsx)(CheckboxCheckedContext.Provider, { value: isChecked, children: element }),
      [isChecked]
    );
    props = {
...
var useFormDescription = createHook(
  function useFormDescription2({
    ...
    const name = `${nameProp}`;
    const getItem = (0, import_react68.useCallback)(
      (item) => {
        const nextItem = {
          ...item,
          id: id || item.id,
...
var useFormError = createHook(
  function useFormError2({
    ...
    const name = `${nameProp}`;
    const getItem = (0, import_react69.useCallback)(
      (item) => {
...
// node_modules/@ariakit/react-core/esm/__chunks/LPZHRGHO.js
var TagName89 = "div";
...
var useFormLabel = createHook(
  function useFormLabel2({
    ...
    const name = `${nameProp}`;
    const getItem = (0, import_react70.useCallback)(
      (item) => {
...
// node_modules/@ariakit/react-core/esm/__chunks/MAEE4WWH.js
...
var useFormPush = createHook(
  function useFormPush2({
    ...
    const name = `${nameProp}`;
    const [shouldFocus, setShouldFocus] = (0, import_react72.useState)(false);
    ...
    const getItem = (0, import_react72.useCallback)(
      (item) => {
...
// node_modules/@ariakit/react-core/esm/__chunks/O6DAAE7K.js
var TagName100 = "p";
...
// node_modules/@ariakit/react-core/esm/__chunks/KRCRS7MN.js
...
// node_modules/@ariakit/react-core/esm/__chunks/IFTBKUWI.js
var TagName103 = "h1";
...
var MenuItemCheckedContext2 = (0, import_react74.createContext)(
  void 0
);
...
function useAriaLabelledBy({ store, ...props }) {
  const [id, setId] = (0, import_react75.useState)(void 0);
  const label = props["aria-label"];
...
var useMenuList = createHook(
  function useMenuList2({ store, alwaysVisible, composite, ...props }) {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime51.jsx)(MenuScopedContextProvider, { value: store, children: element }),
      [store]
    );
...
var useMenu = createHook(function useMenu2({
  ...
  props = menuListProps;
  const [initialFocusRef, setInitialFocusRef] = (0, import_react76.useState)();
  ...
  (0, import_react76.useEffect)(() => {
    ...
    setInitialFocusRef((prevInitialFocusRef) => {
      ...
      const ref2 = (0, import_react76.createRef)();
      switch (initialFocus) {
        case "first":
  ...
  const preserveTabOrderAnchor = (0, import_react76.useMemo)(() => {
...
var useMenuButton = createHook(
  function useMenuButton2({
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime53.jsx)(MenuContextProvider, { value: store, children: element }),
      [store]
    );
    if (hasParentMenu) {
      props = {
        ...props,
        render: (0, import_jsx_runtime53.jsx)(Role.div, { render: props.render })
      };
    }
    const id = useId(props.id);
    const parentContentElement = useStoreState(
...
var useMenuItemCheck = createHook(
  function useMenuItemCheck2({ store, checked, ...props }) {
    const context = (0, import_react81.useContext)(MenuItemCheckedContext2);
    checked = checked != null ? checked : context;
    props = useCheckboxCheck({ ...props, checked });
    return props;
  }
...
var useMenuItemRadio = createHook(
  function useMenuItemRadio2({
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime54.jsx)(MenuItemCheckedContext2.Provider, { value: !!isChecked, children: element }),
      [isChecked]
    );
    props = {
      role: "menuitemradio",
...
var useCollection = createHook(
  function useCollection2({ store, ...props }) {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime57.jsx)(CollectionScopedContextProvider, { value: store, children: element }),
      [store]
    );
    return removeUndefinedValues(props);
  }
...
//# sourceMappingURL=chunk-KKERWAB5.js.map
