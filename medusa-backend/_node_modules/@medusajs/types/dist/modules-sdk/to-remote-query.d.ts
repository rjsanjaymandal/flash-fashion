...
export type RemoteQueryFilters<TEntry extends string, RemoteQueryEntryPointsLevel = RemoteQueryEntryPoints, Exclusion extends string[] = [], Lim extends number = Depth[3]> = RemoteQueryFilterOperators<DeepPartial<InternalRemoteQueryFilters<TEntry, RemoteQueryEntryPointsLevel, Exclusion, Lim>>> & DeepPartial<InternalRemoteQueryFilters<TEntry, RemoteQueryEntryPointsLevel, Exclusion, Lim>>;
export {};
