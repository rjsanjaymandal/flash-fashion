...
class Order {
     ...
     * })
     */
    async updateOrderChange(id, body, query, headers) {
        return await this.client.fetch(`/admin/order-changes/${id}`, {
            method: "POST",
            headers,
            body,
            query,
     ...
     * })
     */
    async export(query, headers) {
        return await this.client.fetch(`/admin/orders/export`, {
            method: "POST",
            headers,
            query,
        });
