...
var _RoutesLoader_instances, _RoutesLoader_routes, _RoutesLoader_getRoutesForFile;
...
class RoutesLoader {
     ...
     */
    async reloadRouteFile(absolutePath, sourceDir) {
        const relativePath = absolutePath.replace(sourceDir, "");
        const route = this.createRoutePath(relativePath);
        const routes = await __classPrivateFieldGet(this, _RoutesLoader_instances, "m", _RoutesLoader_getRoutesForFile).call(this, route, absolutePath);
...
_RoutesLoader_routes = new WeakMap(), _RoutesLoader_instances = new WeakSet(), _RoutesLoader_getRoutesForFile = 
/**
