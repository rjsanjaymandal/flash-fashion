import { CreateOrderLineItemAdjustmentDTO, OrderChangeActionDTO } from "@medusajs/framework/types";
...
export declare function applyChangesToOrder(orders: any[], actionsMap: Record<string, any[]>, options?: {
    ...
    lineItemAdjustmentsToCreate: CreateOrderLineItemAdjustmentDTO[];
    itemsToUpsert: {
        id: string;
        version: number;
