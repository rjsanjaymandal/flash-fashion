...
exports.allowedAllocationTypes = [
    ...
    utils_1.ApplicationMethodAllocation.ONCE,
];
...
function validateApplicationMethodAttributes(data, promotion) {
    ...
    if (allocation === utils_1.ApplicationMethodAllocation.ONCE &&
        targetType === utils_1.ApplicationMethodTargetType.ORDER) {
        throw new utils_1.MedusaError(utils_1.MedusaError.Types.INVALID_DATA, `application_method.allocation 'once' is not compatible with target_type 'order'`);
    }
}
