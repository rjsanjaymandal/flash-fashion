...
exports.InitialSetup20240315083440 = void 0;
...
class InitialSetup20240315083440 extends migrations_1.Migration {
    async up() {
        ...
        if (productTables.length > 0) {
            ...
            this.addSql(`alter table "product_variant" drop column "inventory_quantity";`);
        ...
        this.addSql('create table if not exists "product_variant" ("id" text not null, "title" text not null, "sku" text null, "barcode" text null, "ean" text null, "upc" text null, "allow_backorder" boolean not null default false, "manage_inventory" boolean not null default true, "hs_code" text null, "origin_country" text null, "mid_code" text null, "material" text null, "weight" numeric null, "length" numeric null, "height" numeric null, "width" numeric null, "metadata" jsonb null, "variant_rank" numeric null default 0, "product_id" text null, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "product_variant_pkey" primary key ("id"));');
...
//# sourceMappingURL=InitialSetup20240401153642.js.map