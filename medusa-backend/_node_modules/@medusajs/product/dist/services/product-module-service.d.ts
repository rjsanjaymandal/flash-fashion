...
import { UpdateCollectionInput, UpdateProductInput, UpdateProductOptionInput, UpdateProductVariantInput, VariantImageInputArray } from "../types";
...
export default class ProductModuleService extends ProductModuleService_base implements ProductTypes.IProductModuleService {
    ...
    listProductVariants(filters?: ProductTypes.FilterableProductVariantProps, config?: FindConfig<ProductTypes.ProductVariantDTO>, sharedContext?: Context): Promise<ProductTypes.ProductVariantDTO[]>;
    listAndCountProductVariants(filters?: ProductTypes.FilterableProductVariantProps, config?: FindConfig<ProductTypes.ProductVariantDTO>, sharedContext?: Context): Promise<[ProductTypes.ProductVariantDTO[], number]>;
    retrieveProductVariant(id: string, config?: FindConfig<any>, sharedContext?: Context): Promise<any>;
    addImageToVariant(data: VariantImageInputArray, sharedContext?: Context): Promise<{
        id: string;
    }[]>;
    protected addImageToVariant_(data: VariantImageInputArray, sharedContext?: Context): Promise<{
        id: string;
    } | {
        id: string;
    }[]>;
    removeImageFromVariant(data: VariantImageInputArray, sharedContext?: Context): Promise<void>;
    protected removeImageFromVariant_(data: VariantImageInputArray, sharedContext?: Context): Promise<void>;
    private getVariantImages;
    private buildVariantImagesFromProduct;
}
export {};
