...
exports.AdminGetProductsParamsDirectFields = zod_1.z.object({
    variants: validators_2.AdminGetProductVariantsParamsFields.omit({ q: true })
        .merge((0, common_validators_1.applyAndAndOrOperators)(validators_2.AdminGetProductVariantsParamsFields.omit({ q: true })))
        .optional(),
...
exports.UpdateProduct = zod_1.z
    ...
    description: zod_1.z.string().nullish(),
    images: zod_1.z
        .array(zod_1.z.object({ id: zod_1.z.string().optional(), url: zod_1.z.string() }))
        .optional(),
    thumbnail: zod_1.z.string().nullish(),
...
exports.AdminBatchDeleteVariantInventoryItem = zod_1.z
    ...
    .strict();
exports.AdminBatchImageVariant = zod_1.z.object({
    add: zod_1.z.array(zod_1.z.string()).optional(),
    remove: zod_1.z.array(zod_1.z.string()).optional(),
});
exports.AdminBatchVariantImages = zod_1.z.object({
    add: zod_1.z.array(zod_1.z.string()).optional(),
    remove: zod_1.z.array(zod_1.z.string()).optional(),
});
