...
exports.adminRefundReasonsRoutesMiddlewares = [
    {
        ...
        policies: [
            {
                resource: query_config_1.Entities.refund_reason,
    ...
    },
    {
        ...
        middlewares: [
            ...
            (0, framework_1.validateAndTransformQuery)(validators_1.AdminGetRefundReasonParams, queryConfig.retrieveTransformQueryConfig),
        ],
        policies: [
            {
                resource: query_config_1.Entities.refund_reason,
