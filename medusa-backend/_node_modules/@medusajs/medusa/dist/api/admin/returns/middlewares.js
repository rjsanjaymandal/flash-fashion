...
exports.adminReturnRoutesMiddlewares = [
    {
        ...
        policies: [
            {
                resource: query_config_1.Entities.return,
    ...
    },
    {
        ...
        middlewares: [
            (0, framework_1.validateAndTransformQuery)(validators_1.AdminGetReturnParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
        method: ["POST"],
