...
export declare const POST: (req: AuthenticatedMedusaRequest<AdminCreateCollectionType & AdditionalData, HttpTypes.AdminCollectionParams>, res: MedusaResponse<HttpTypes.AdminCollectionResponse>) => Promise<void>;
