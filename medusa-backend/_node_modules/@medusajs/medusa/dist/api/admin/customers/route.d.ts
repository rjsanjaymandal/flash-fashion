...
export declare const POST: (req: AuthenticatedMedusaRequest<AdminCreateCustomerType & AdditionalData, HttpTypes.SelectParams>, res: MedusaResponse<HttpTypes.AdminCustomerResponse>) => Promise<void>;
