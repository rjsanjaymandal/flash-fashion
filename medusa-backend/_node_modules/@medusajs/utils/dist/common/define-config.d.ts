import { ConfigModule, InputConfigModules, InputConfigWithArrayModules, InputConfigWithObjectModules } from "@medusajs/types";
 ...
 */
export declare function defineConfig(config?: InputConfigWithArrayModules): ConfigModule;
/**
 * @deprecated Use array-based modules configuration instead
 */
export declare function defineConfig(config?: InputConfigWithObjectModules): ConfigModule;
/**
