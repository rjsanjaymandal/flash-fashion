...
function calculateCreditLinesTotal({ creditLines, includesTax, taxRate, currencyCode, }) {
    ...
    const upperCurCode = currencyCode?.toUpperCase();
    ...
    const isZero = math_1.MathBN.lte(creditLinesTotal, currencyEpsilon);
    return {
