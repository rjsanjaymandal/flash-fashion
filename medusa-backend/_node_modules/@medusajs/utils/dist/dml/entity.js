...
var _DmlEntity_instances, _DmlEntity_tableName, _DmlEntity_cascades, _DmlEntity_indexes, _DmlEntity_checks, _DmlEntity_registerTranslatableFields, _a;
...
class DmlEntity {
    constructor(nameOrConfig, schema) {
        ...
        __classPrivateFieldGet(this, _DmlEntity_instances, "m", _DmlEntity_registerTranslatableFields).call(this, name, schema);
    }
    /**
    ...
    static getTranslatableEntities() {
        return Array.from(TRANSLATABLE_ENTITIES.entries()).map(([entity, fields]) => ({
            entity,
...
_DmlEntity_tableName = new WeakMap(), _DmlEntity_cascades = new WeakMap(), _DmlEntity_indexes = new WeakMap(), _DmlEntity_checks = new WeakMap(), _DmlEntity_instances = new WeakSet(), _a = IsDmlEntity, _DmlEntity_registerTranslatableFields = function _DmlEntity_registerTranslatableFields(entityName, schema) {
