...
function createMikrORMEntity() {
    ...
    function createEntity(entity) {
        ...
        (0, core_1.Entity)({ tableName })((0, core_1.Filter)(dal_1.mikroOrmSoftDeletableFilterOptions)(MikroORMEntity));
        const entityMetadata = core_1.MetadataStorage.getMetadataFromDecorator(MikroORMEntity);
        ENTITIES[modelName] = entityMetadata.class;
