 ...
 * @param primaryKeys
 */
export declare function defineJoinerConfig(serviceName: string, { alias, schema, models, linkableKeys, primaryKeys, idPrefixToEntityName, }?: {
 ...
 * @param models
 */
export declare function buildIdPrefixToEntityNameFromDmlObjects(models: DmlEntity<any, any>[]): Record<string, string>;
/**
