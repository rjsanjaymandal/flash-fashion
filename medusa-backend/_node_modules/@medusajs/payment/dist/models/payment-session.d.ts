...
declare const PaymentSession: import("@medusajs/framework/utils").DmlEntity<import("@medusajs/framework/utils").DMLEntitySchemaBuilder<{
    ...
    status: import("@medusajs/framework/utils").EnumProperty<typeof PaymentSessionStatus>;
