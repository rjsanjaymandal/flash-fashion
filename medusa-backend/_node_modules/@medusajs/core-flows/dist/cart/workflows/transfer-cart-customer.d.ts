 ...
 */
export declare const transferCartCustomerWorkflow: import("@medusajs/framework/workflows-sdk").ReturnWorkflow<TransferCartCustomerWorkflowInput & AdditionalData, undefined, [import("@medusajs/framework/workflows-sdk").Hook<"validate", {
