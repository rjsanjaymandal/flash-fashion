...
exports.updateCartWorkflow = (0, workflows_sdk_1.createWorkflow)({
    ...
    (0, steps_1.validateCartStep)({ cart: cartToUpdate });
    ...
    */
    ...
    const newLocaleCode = (0, workflows_sdk_1.transform)({ input, cartToUpdate }, ({ input, cartToUpdate }) => {
        if ((0, utils_1.isDefined)(input.locale) && input.locale !== cartToUpdate?.locale) {
            return input.locale;
        }
        return undefined;
    });
