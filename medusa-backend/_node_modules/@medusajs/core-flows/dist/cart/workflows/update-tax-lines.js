...
const get_translated_tax_lines_1 = require("../../common/steps/get-translated-tax-lines");
const cartFields = [
    "id",
    "currency_code",
    "email",
...
exports.updateTaxLinesWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.updateTaxLinesWorkflowId, (input) => {
    ...
    const translatedTaxLines = (0, get_translated_tax_lines_1.getTranslatedTaxLinesStep)({
    ...
    (0, steps_1.setTaxLinesForItemsStep)({
        cart,
        item_tax_lines: translatedTaxLines.itemTaxLines,
        shipping_tax_lines: translatedTaxLines.shippingTaxLines,
    });
