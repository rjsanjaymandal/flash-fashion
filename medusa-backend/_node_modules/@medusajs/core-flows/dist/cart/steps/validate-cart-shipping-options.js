...
exports.validateCartShippingOptionsStep = (0, workflows_sdk_1.createStep)(exports.validateCartShippingOptionsStepId, async (data, { container }) => {
    ...
    let validShippingOptionIds;
    if (!prefetchedShippingOptions) {
        if (!cart || !shippingOptionsContext) {
            throw new utils_1.MedusaError(utils_1.MedusaError.Types.INVALID_DATA, `Cart and shippingOptionsContext need to be defined if prefetchedShippingOptions is not.`);
        }
