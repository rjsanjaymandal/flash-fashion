...
exports.deleteShippingOptionsWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.deleteShippingOptionsWorkflowId, (input) => {
    ...
    (0, workflows_sdk_1.parallelize)((0, common_1.removeRemoteLinkStep)(softDeletedEntities), (0, common_1.emitEventStep)({
        eventName: utils_1.ShippingOptionWorkflowEvents.DELETED,
        data: input.ids,
    }));
});
