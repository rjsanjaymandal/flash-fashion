...
exports.createShippingOptionsWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.createShippingOptionsWorkflowId, (input) => {
    ...
    const eventData = (0, workflows_sdk_1.transform)(createdShippingOptions, (data) => {
    ...
    (0, workflows_sdk_1.parallelize)((0, set_shipping_options_price_sets_1.setShippingOptionsPriceSetsStep)(normalizedLinkData), (0, common_1.emitEventStep)({
        eventName: utils_1.ShippingOptionWorkflowEvents.CREATED,
        data: eventData,
    }));
