...
const dismiss_product_variants_inventory_1 = require("../steps/dismiss-product-variants-inventory");
...
exports.updateProductsWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.updateProductsWorkflowId, (input) => {
    ...
    const variantsToDismissInventory = (0, workflows_sdk_1.transform)({ input, updatedProducts }, (data) => {
        const variantIds = [];
        if ("products" in data.input) {
    ...
    (0, dismiss_product_variants_inventory_1.dismissProductVariantsInventoryStep)({
