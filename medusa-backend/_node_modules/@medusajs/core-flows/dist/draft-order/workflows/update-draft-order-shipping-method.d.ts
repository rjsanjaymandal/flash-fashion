 ...
 */
export declare const updateDraftOrderShippingMethodWorkflow: import("@medusajs/framework/workflows-sdk").ReturnWorkflow<UpdateDraftOrderShippingMethodWorkflowInput, import("@medusajs/framework/types").OrderPreviewDTO, []>;
