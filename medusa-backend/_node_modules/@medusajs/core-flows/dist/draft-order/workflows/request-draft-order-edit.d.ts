 ...
 */
export declare const requestDraftOrderEditWorkflow: import("@medusajs/framework/workflows-sdk").ReturnWorkflow<RequestDraftOrderEditWorkflowInput, import("@medusajs/framework/types").OrderPreviewDTO, []>;
