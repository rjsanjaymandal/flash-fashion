 ...
 */
export declare const beginDraftOrderEditWorkflow: import("@medusajs/framework/workflows-sdk").ReturnWorkflow<OrderWorkflow.BeginorderEditWorkflowInput, import("@medusajs/framework/types").OrderPreviewDTO, []>;
