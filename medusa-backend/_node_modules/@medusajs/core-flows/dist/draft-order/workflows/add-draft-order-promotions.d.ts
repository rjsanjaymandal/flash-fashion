 ...
 */
export declare const addDraftOrderPromotionWorkflow: import("@medusajs/framework/workflows-sdk").ReturnWorkflow<AddDraftOrderPromotionWorkflowInput, import("@medusajs/framework/types").OrderPreviewDTO, []>;
