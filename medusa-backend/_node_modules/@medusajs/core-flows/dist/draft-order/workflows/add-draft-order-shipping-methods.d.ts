 ...
 */
export declare const addDraftOrderShippingMethodsWorkflow: import("@medusajs/framework/workflows-sdk").ReturnWorkflow<AddDraftOrderShippingMethodsWorkflowInput, import("@medusajs/framework/types").OrderPreviewDTO, []>;
