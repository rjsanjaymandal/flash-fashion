 ...
 */
export declare const confirmDraftOrderEditWorkflow: import("@medusajs/framework/workflows-sdk").ReturnWorkflow<ConfirmDraftOrderEditWorkflowInput, import("@medusajs/framework/types").OrderPreviewDTO, []>;
