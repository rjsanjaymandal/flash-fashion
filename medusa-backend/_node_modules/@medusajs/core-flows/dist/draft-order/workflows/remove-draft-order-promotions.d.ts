 ...
 */
export declare const removeDraftOrderPromotionsWorkflow: import("@medusajs/framework/workflows-sdk").ReturnWorkflow<RemoveDraftOrderPromotionsWorkflowInput, import("@medusajs/framework/types").OrderPreviewDTO, []>;
