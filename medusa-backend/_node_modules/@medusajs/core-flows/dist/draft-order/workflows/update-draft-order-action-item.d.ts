 ...
 */
export declare const updateDraftOrderActionItemWorkflow: import("@medusajs/framework/workflows-sdk").ReturnWorkflow<OrderWorkflow.UpdateOrderEditAddNewItemWorkflowInput, import("@medusajs/framework/types").OrderPreviewDTO, []>;
