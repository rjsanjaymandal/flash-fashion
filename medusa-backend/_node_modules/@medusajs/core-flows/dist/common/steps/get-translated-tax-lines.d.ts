...
export declare const getTranslatedTaxLinesStepId = "get-translated-tax-lines-step";
 ...
 * })
 */
export declare const getTranslatedTaxLinesStep: import("@medusajs/framework/workflows-sdk").StepFunction<GetTranslatedTaxLinesStepInput, {
    itemTaxLines: ItemTaxLineDTO[] | ShippingTaxLineDTO[];
    shippingTaxLines: ItemTaxLineDTO[] | ShippingTaxLineDTO[];
}>;
//# sourceMappingURL=get-translated-tax-lines.d.ts.map