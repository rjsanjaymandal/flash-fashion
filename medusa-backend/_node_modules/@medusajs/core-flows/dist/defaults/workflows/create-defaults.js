...
exports.createDefaultsWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.createDefaultsWorkflowID, () => {
    ...
    (0, workflows_sdk_1.when)({ publishableApiKey }, ({ publishableApiKey }) => !publishableApiKey?.data).then(() => {
        const createResult = (0, api_key_1.createApiKeysStep)({
            api_keys: [
                {
        ...
        const publishableApiKey = (0, workflows_sdk_1.transform)({ createResult }, ({ createResult }) => {
            return createResult[0];
        });
        api_key_1.linkSalesChannelsToApiKeyWorkflow.runAsStep({
            input: {
