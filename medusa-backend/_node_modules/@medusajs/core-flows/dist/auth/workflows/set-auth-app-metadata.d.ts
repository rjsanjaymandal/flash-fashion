 ...
 * ```
 */
export declare const setAuthAppMetadataWorkflow: import("@medusajs/framework/workflows-sdk").ReturnWorkflow<SetAuthAppMetadataStepInput, import("@medusajs/types").AuthIdentityDTO, []>;
