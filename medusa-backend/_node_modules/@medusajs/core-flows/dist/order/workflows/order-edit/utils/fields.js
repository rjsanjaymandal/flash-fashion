...
exports.fieldsToRefreshOrderEdit = exports.fieldsToComputeAdjustmentsForPreview = void 0;
exports.fieldsToComputeAdjustmentsForPreview = [
    "id",
    "currency_code",
    "email",
    "sales_channel_id",
...
exports.fieldsToRefreshOrderEdit = [
    "id",
    "status",
    "version",
    "currency_code",
