import type { ItemTaxLineDTO, OrderWorkflowDTO, ShippingTaxLineDTO } from "@medusajs/framework/types";
...
export declare const updateOrderTaxLinesWorkflow: import("@medusajs/framework/workflows-sdk").ReturnWorkflow<UpdateOrderTaxLinesWorkflowInput, {
    itemTaxLines: (ItemTaxLineDTO[] | WorkflowData<ItemTaxLineDTO[]>) & ItemTaxLineDTO[];
    shippingTaxLines: (ShippingTaxLineDTO[] | WorkflowData<ShippingTaxLineDTO[]>) & ShippingTaxLineDTO[];
}, []>;
