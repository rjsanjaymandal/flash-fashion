 ...
 */
export declare const deleteLineItemsWorkflow: import("@medusajs/framework/workflows-sdk").ReturnWorkflow<DeleteLineItemsWorkflowInput & AdditionalData, unknown, any[]>;
